...
| **Related model** | LikeC4 source model `architecture/tobe/ram-architecture.c4` |
...
**Out of scope:** internal RAM component design, detailed data contracts, field-level mappings (see References), and non-functional sizing — these are captured in dedicated artefacts or marked as TODO below.
...
The high-level system context below is the primary overview of RAM's external integrations and the source this document elaborates on (currently at draft revision v0.1D). It is generated from the LikeC4 model and should be regenerated when that model changes (see References).

![RAM System Context](../../../architecture/tobe/diagrams/systemContext.png)

*Figure 1 — RAM System Context (v0.1D Draft).*

For the internal container/component view that these integrations connect into, see the **RAM Containers** diagram.
...
| Detailed design | Companion pages: **JO (eLinks) — RAM ER Diagram** and **JO (eLinks) — RAM Schema & Source Mapping** |
...
> **TODO:** Expand "MRD" on first use and describe the dataset's purpose within RAM.
...
| Artefact | Location |
|---|---|
| LikeC4 architecture model (source of the diagrams) | `architecture/tobe/ram-architecture.c4` |
| System context diagram | `architecture/tobe/diagrams/systemContext.png` |
| RAM containers diagram | `architecture/tobe/diagrams/ramContainers.png` |
| Capability map | `architecture/tobe/diagrams/capabilityMap.png` |
| JOH Source System (eLinks) — ER diagram | Companion page: **JO (eLinks) — RAM ER Diagram** |
| JOH Source System (eLinks) — schema mapping | Companion page: **JO (eLinks) — RAM Schema & Source Mapping** |
